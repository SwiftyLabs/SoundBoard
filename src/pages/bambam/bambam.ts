...
@Component({
  templateUrl: 'bambam.html'
})
export class BambamPage {

  /* EDIT THESE */
  title: string = "Bambam";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "BamBam";
  counter: number =1;  
  sounds: any = [];
  media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/orange-button-unclicked.png';
            let imageUrlUnclicked = 'assets/orange-button-';            
            let color = '#F9A600';           

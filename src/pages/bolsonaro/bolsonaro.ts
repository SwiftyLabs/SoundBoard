...
@Component({
  templateUrl: 'bolsonaro.html'
})
export class BolsonaroPage {

  /* EDIT THESE */
  title: string = "Bolsonaro";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Bolsonaro";
  counter: number =1;  
  sounds: any = [];
media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/blue-button-unclicked.png';
            let imageUrlUnclicked = 'assets/blue-button-';            
            let color = '#203be3';           

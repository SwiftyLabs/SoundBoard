...
@Component({
  templateUrl: 'davy.html'
})
export class DavyPage {

  /* EDIT THESE */
  title: string = "Davy";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Davy";
  counter: number =1;  
  sounds: any = [];
media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/mintgreen-button-unclicked.png';
            let imageUrlUnclicked = 'assets/mintgreen-button-';            
            let color = '#238e49';           

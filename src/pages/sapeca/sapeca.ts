...
@Component({
  templateUrl: 'sapeca.html'
})
export class SapecaPage {

  /* EDIT THESE */
  title: string = "Sapeca";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Sapeca";
  counter: number =1;  
  sounds: any = [];
media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/sapeca-button-unclicked.png';
            let imageUrlUnclicked = 'assets/sapeca-button-';            
            let color = '#93e904';           

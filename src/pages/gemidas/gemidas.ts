...
@Component({
  templateUrl: 'gemidas.html'
})
export class GemidasPage {

  /* EDIT THESE */
  title: string = "Gemidas";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Gemidas";
  counter: number =1;  
  sounds: any = [];
  media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/gemida-button-unclicked.png';
            let imageUrlUnclicked = 'assets/gemida-button-';            
            let color = '#eb5bea';           

...
@Component({
  templateUrl: 'miseravi.html'
})
export class MiseraviPage {

  /* EDIT THESE */
  title: string = "Miseravi";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Miseravi";
  counter: number =1;  
  sounds: any = [];
media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/pink-button-unclicked.png';
            let imageUrlUnclicked = 'assets/pink-button-';            
            let color = '#ff00a3';           

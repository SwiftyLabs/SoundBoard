...
@Component({
  templateUrl: 'diadasemana.html'
})
export class DiadasemanaPage {

  /* EDIT THESE */
  title: string = "Dia da semana";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Diadasemana";
  counter: number =1;  
  sounds: any = [];
media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/aqua-button-unclicked.png';
            let imageUrlUnclicked = 'assets/aqua-button-';            
            let color = '#007786';           

...
@Component({
  templateUrl: 'mateiformiga.html'
})  
export class MateiformigaPage {

  /* EDIT THESE */
  title: string = "mateiformiga";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Mateiformiga";
  counter: number =1;  
  sounds: any = [];
  media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/mateiformiga-button-unclicked.png';
            let imageUrlUnclicked = 'assets/mateiformiga-button-';            
            let color = '#d28ca2';           
...
openUrl(url){
        url="https://www.youtube.com/user/mateiformiga"       

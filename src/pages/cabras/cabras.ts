...
@Component({
  templateUrl: 'cabras.html'
})
export class CabrasPage {

  /* EDIT THESE */
  title: string = "Cabras";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Cabras";
  counter: number =1;  
  sounds: any = [];
media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/cabras-button-unclicked.png';
            let imageUrlUnclicked = 'assets/cabras-button-';            
            let color = '#bf9750';           

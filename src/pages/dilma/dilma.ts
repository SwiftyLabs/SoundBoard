...
@Component({
  templateUrl: 'dilma.html'
})
export class DilmaPage {

  /* EDIT THESE */
  title: string = "Dilma";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Dilma";
  counter: number =1;  
  sounds: any = [];
  media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/red-button-unclicked.png';
            let imageUrlUnclicked = 'assets/red-button-';            
            let color = '#E00400';           

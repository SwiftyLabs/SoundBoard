...
@Component({
  templateUrl: 'xingamentos.html'
})
export class XingamentosPage {

  /* EDIT THESE */
  title: string = "Xingamentos";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Xingamentos";
  counter: number =1;  
  sounds: any = [];
media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/gray-button-unclicked.png';
            let imageUrlUnclicked = 'assets/gray-button-';            
            let color = '#898580';           

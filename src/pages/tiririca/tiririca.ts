...
@Component({
  templateUrl: 'tiririca.html'
})
export class TiriricaPage {

  /* EDIT THESE */
  title: string = "Tiririca";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Tiririca";
  counter: number = 1;
  sounds: any = [];
  media: any = null;
  icon: string;
    ...
    this.http.get(this.base_url + this.sounds_url)
      ...
      data => {
        ...
        for (let link of links) {
          ...
          let imageUrl = 'assets/tiririca-button-unclicked.png';
          let imageUrlUnclicked = 'assets/tiririca-button-';
          let color = '#67d199';

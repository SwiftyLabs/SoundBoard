...
export class GuitarraPage {

  /* EDIT THESE */
  title: string = "Guitarra";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Guitarra";
  counter: number =1;  
  sounds: any = [];
media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/violet2-button-unclicked.png';
            let imageUrlUnclicked = 'assets/violet2-button-';            
            let color = '#d3bcee';           

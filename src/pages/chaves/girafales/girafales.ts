...
@Component({
  templateUrl: 'girafales.html'
})
export class GirafalesPage {

  /* EDIT THESE */
  title: string = "Girafales";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/Chaves/";
  sounds_url: string = "Girafales";
  counter: number =1;  
  sounds: any = [];
media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/chaves-button-unclicked.png';
            let imageUrlUnclicked = 'assets/chaves-button-';            
            let color = '#44782d';           

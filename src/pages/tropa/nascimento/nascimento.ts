...
@Component({
  templateUrl: 'nascimento.html'
})
export class NascimentoPage {

  /* EDIT THESE */
  title: string = "Nascimento";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/Tropa/";
  sounds_url: string = "Nascimento";
  counter: number =1;  
  sounds: any = [];
media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/tropa-button-unclicked.png';
            let imageUrlUnclicked = 'assets/tropa-button-';            
            let color = '#5a648b';           

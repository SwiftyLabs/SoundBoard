      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/sand-button-unclicked.png';
            let imageUrlUnclicked = 'assets/sand-button-';            
            let color = '#bfad57';           

...
@Component({
  templateUrl: 'otavio.html'
})
export class OtavioPage {

  /* EDIT THESE */
  title: string = "Otavio";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Otavio";
  counter: number =1;  
  sounds: any = [];
media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/otavio-button-unclicked.png';
            let imageUrlUnclicked = 'assets/otavio-button-';            
            let color = '#2cbc61';           

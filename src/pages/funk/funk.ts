...
@Component({
  templateUrl: 'funk.html'
})
export class FunkPage {

  /* EDIT THESE */
  title: string = "Funk";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Funk";
  counter: number =1;  
  sounds: any = [];
media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/violet-button-unclicked.png';
            let imageUrlUnclicked = 'assets/violet-button-';            
            let color = '#A10045';           

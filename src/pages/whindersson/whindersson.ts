...
@Component({
  templateUrl: 'whindersson.html'
})
export class WhinderssonPage {

  /* EDIT THESE */
  title: string = "Whindersson";
  base_url: string = "https://sound-board-cc576.firebaseapp.com/";
  sounds_url: string = "Whindersson";
  counter: number =1;  
  sounds: any = [];
media: any = null;
  icon: string;
      ...
      .subscribe(
        data => {
          ...
          for(let link of links) {
            ...
            let imageUrl = 'assets/win-button-unclicked.png';
            let imageUrlUnclicked = 'assets/win-button-';            
            let color = '#b48379';           
